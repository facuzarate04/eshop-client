            ...
            <div class="relative sm:max-w-sm w-full">
                ...
                <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                    ...
                    <form @submit.prevent="login" class="mt-10">
                        ...
                        <div>
                            <input v-model="loginForm.email" type="email" placeholder="Correo electronico" class="mt-1 px-2 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
                        </div>
            
                        <div class="mt-7">                
                            <input v-model="loginForm.password" type="password" placeholder="Contraseña" class="mt-1 px-2 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">                           
                        </div>

                        <div class="mt-7 flex">
                            <label for="remember_me" class="inline-flex items-center w-full cursor-pointer">
                                <input v-model="loginForm.remember" id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="remember">
                        ...
                        <div class="mt-7">
                            <div class="flex justify-center items-center">
                                ...
                                <router-link :to="{name: 'register'}" class=" text-blue-500 transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                                    Crea una cuenta
                                </router-link>
                            </div>
                        </div>
